...
console.log(color('\nمرحبًا ، أنا غـون ، المطور الرئيسي لهذا البوت.\n\nشكرًا لاستخدام: ◤𝙀𝙈𝙋𝙀𝙍𝙊𝙍🦂𝘼𝙉𝙐𝙎◢','aqua'))
...
Miku.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                let WAuserName = num
                mikutext =
 `أنــــورتِ✨نــــــــورتِ يـاقـمر🌚🤗@${WAuserName.split("@")[0]},

انا *الزعيم غــــون*, مرحبا بك في ${metadata.subject}.

* وصف الجروب:*
${metadata.desc}

نورت الجروب يا قـمـر😍😭
`
...
⚜️🦇, فـي داهـيه لارجعه منها🗿امزح امزح😂تروح وترجعِ بالسلامه ياغالي/ه😂💔!
`
