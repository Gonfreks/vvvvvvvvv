rocess.on('uncaughtException', console.error)
require("./config")
...
const ftroli = {
  ...
  const jumlahUser = pendaftar.length
    ...
    const menulist = `
    70o0o0da BEH ${pushname} 👋. انا غـون ${global.BotName}, بوت تم تطويري بواسطة: غـون بيه للانتقال باستخدام واتساب إلى المستوى التالي.
...
↲ انا الزعيم غون 🦇*, 
تم تطويري بواسطة *70ا الزعيم غـون ❤️*.↲

♠️ البادئة الخاصة بي هي:  ${prefix}
 
*✶━━━✲─ • ❨🤖❩ • ─✲━━━✶*
اوامر قليل ولاكنت نحن نطور البوت يومن على يوم↲
*اهلاً وسهلا بكم في بوت الزعيم غون☺️* 
*"هنا اوامر البوت يرجى منكم استخدام البوت بالفائده"*
*وانـ شاءالله يعجبكم🤗*
*✶━━━✲─ • ❨اوامر اضافيه📀❩ • ─✲━━━✶*
↲بروفايل║
↲الاوامر ║↲
...
*✶━━━✲─ • ❨🤖❩ • ─✲━━━✶
شكرا لك على استخدام بوت غون
اذا اعجبكـ البـوت. فـ الحمدلله واذا لم يعجبك فـ انا اسف لانك لم تجد متطلباتك هنا🙂
...
const txt = `  غـون هنا🌚❤️ / رقمي للتواصل معايا:https://api.whatsapp.com/send?phone=+201146121794    `
const mikuarray= [
